...
class ActivateModule(Telecommand):
    """
    Activate module telecommand.
    """
    def __init__(self):
        """
        Constructor.
        """
        super().__init__(0x45, "activate_module")
    ...
    def generate(self, src_adr, mod_id, key):
        ...
        :param: mod_id: is the ID of the module to activate.

...
class DialogGetTable(Gtk.Dialog):
    def __init__(self, parent):
        super().__init__(title="Get Table", transient_for=parent, flags=0)
        ...
        label2 = Gtk.Label(label="Table ID:")
        label2.set_halign(Gtk.Align.START)
        self.entry_table_id = Gtk.Entry()
        ...
        grid.attach(label2, 0, 1, 1, 1)
        grid.attach(self.entry_subsys_id, 1, 0, 1, 1)
        grid.attach(self.entry_table_id, 1, 1, 1, 1)

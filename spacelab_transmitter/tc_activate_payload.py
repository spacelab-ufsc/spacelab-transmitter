...
class ActivatePayload(Telecommand):
    """
    Activate payload telecommand.
    """
    def __init__(self):
        """
        Constructor.
        """
        super().__init__(0x47, "activate_payload")
    ...
    def generate(self, src_adr, pl_id, key):
        ...
        :param: pl_id: is the ID of the payload to activate.

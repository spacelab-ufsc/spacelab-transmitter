...
class GetPayloadData(Telecommand):
    """
    Get Payload Data
    """
    def __init__(self):
        ...
        Constructor
        """
        super().__init__(0x4B, "get_payload_data")
    
    def generate(self, src_adr, pl_id, pl_args, key):

        """This telecommand is composed by four fields:

            Packet ID (1 byte = 0x4B).
        ...
        :param: pl_id: payload ID.
        :param: pl_args: is the payload arguments [list of bytes].
        :param: key: is the telecommand key (ASCII string).
        :return: The generated payload as list of integers.

        """

        pl = [self.get_id()] + self._prepare_callsign(src_adr) + [pl_id] + pl_args

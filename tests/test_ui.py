...
def test_ui():
    ...
    button_get_table                = builder.get_object("button_get_table")
    button_upload_data              = builder.get_object("button_upload_data")
    ...
    assert button_get_table                 != None
    assert button_upload_data               != None
    ...
    entry_preferences_general_latitude      = builder.get_object("entry_preferences_general_latitude")
    entry_preferences_general_longitude     = builder.get_object("entry_preferences_general_longitude")
    ...
    assert entry_preferences_general_latitude       != None
    assert entry_preferences_general_longitude      != None
